...
"""
An example of a simple procedural program. Asks the user for a URL retrieves the content of the URL
(http:// or https:// required), writes to a temp-file, and repeats until the user tells it to stop.
"""
